...
5. [Key Engineering Challenges](#key-engineering-challenges)
   - [Personalized Opportunity Ranking at Scale](#personalized-opportunity-ranking-at-scale)
6. [System Design Decisions](#system-design-decisions)
7. [Controller Conventions](#controller-conventions)
   - [asyncHandler](#asynchandler)
   - [parsePagination Middleware](#parsepagination-middleware)
