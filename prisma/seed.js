...
async function main() {
  ...
  await prisma.notification.createMany({
    data: [
      ...
      { userId: charity1User.id, title: "New Application Received", message: "Karim Haddad applied for \"Karantina Market — April Weekend Volunteers\".", type: "INFO", isRead: false, link: "/applications" },
      { userId: charity1User.id, title: "New Application Received", message: "Nadia Awad applied for \"Karantina Market — April Weekend Volunteers\".", type: "INFO", isRead: false, link: "/applications" },
      { userId: charity1User.id, title: "New Application Received", message: "Karim Haddad applied for \"Bourj Hammoud Blanket Distribution\".", type: "INFO", isRead: true, link: "/applications" },
      { userId: charity1User.id, title: "Volunteer Rated", message: "You rated Karim Haddad 5/5 for \"Karantina Market Setup\".", type: "SUCCESS", isRead: true, link: "/volunteers" },
      { userId: charity1User.id, title: "Certificate Issued", message: "Certificate issued to Karim Haddad for completing \"Karantina Market Setup — March Shift\".", type: "INFO", isRead: true, link: "/certificates" },
      { userId: charity1User.id, title: "Post Liked", message: "5 people liked your post about Karantina Community Market project update.", type: "SUCCESS", isRead: false, link: "/posts" },
      { userId: charity1User.id, title: "New Comment", message: "Karim Haddad commented on your post: \"Signed up for next Saturday's shift!\"", type: "INFO", isRead: false, link: "/posts" },

      // Charity - Nusaned (charity2)
      { userId: charity2User.id, title: "New Application Received", message: "Omar Darwish applied for \"University Application Support Sessions\".", type: "INFO", isRead: false, link: "/applications" },
      { userId: charity2User.id, title: "New Application Received", message: "Rami Najjar applied for \"University Application Support Sessions\".", type: "INFO", isRead: true, link: "/applications" },
      { userId: charity2User.id, title: "Application Approved", message: "Lara Mouawad's application for \"Scholarship Interview Day\" was approved.", type: "SUCCESS", isRead: true, link: "/applications" },
      { userId: charity2User.id, title: "Volunteer Rated", message: "You rated Lara Mouawad 5/5 for \"Scholarship Interview Day\".", type: "SUCCESS", isRead: true, link: "/volunteers" },
      { userId: charity2User.id, title: "Certificate Issued", message: "Certificate issued to Lara Mouawad for \"Scholarship Interview Day\".", type: "INFO", isRead: true, link: "/certificates" },
      { userId: charity2User.id, title: "Project Update", message: "Your project \"Scholarship Fund 2026\" has 2 new applications this week.", type: "INFO", isRead: false, link: "/projects" },

      // Charity - Arcenciel (charity3)
      { userId: charity3User.id, title: "New Application Received", message: "Maya Sarkis applied for \"Bekaa Health Clinic — Zahle Session\".", type: "INFO", isRead: false, link: "/applications" },
      { userId: charity3User.id, title: "New Application Received", message: "Omar Darwish applied for \"Bekaa Health Clinic — Zahle Session\".", type: "INFO", isRead: true, link: "/applications" },
      { userId: charity3User.id, title: "Application Approved", message: "Maya Sarkis's application for \"Bekaa Health Clinic\" was approved.", type: "SUCCESS", isRead: true, link: "/applications" },
      { userId: charity3User.id, title: "Post Liked", message: "4 people liked your post about Bekaa Mobile Health Clinic completing 12th session.", type: "SUCCESS", isRead: false, link: "/posts" },
      { userId: charity3User.id, title: "New Comment", message: "Maya Sarkis commented on your post: \"Already applying for the next rotation!\"", type: "INFO", isRead: false, link: "/posts" },

      // Charity - Lebanese Food Bank (charity4)
      { userId: charity4User.id, title: "New Application Received", message: "Lara Mouawad applied for \"Ramadan Food Parcel Packing\".", type: "INFO", isRead: false, link: "/applications" },
      { userId: charity4User.id, title: "New Application Received", message: "Karim Haddad applied for \"Ramadan Food Parcel Packing\".", type: "INFO", isRead: false, link: "/applications" },
      { userId: charity4User.id, title: "New Application Received", message: "Nadia Awad applied for \"Ramadan Food Parcel Packing\".", type: "INFO", isRead: true, link: "/applications" },
      { userId: charity4User.id, title: "New Application Received", message: "Omar Darwish applied for \"Ramadan Iftar Distribution — Tariq El Jdideh\".", type: "INFO", isRead: false, link: "/applications" },
      { userId: charity4User.id, title: "Application Approved", message: "Lara Mouawad and Karim Haddad's applications for \"Ramadan Food Parcel Packing\" were approved.", type: "SUCCESS", isRead: true, link: "/applications" },
      { userId: charity4User.id, title: "Post Liked", message: "3 people liked your post about Ramadan Food Drive 2026.", type: "SUCCESS", isRead: false, link: "/posts" },
      { userId: charity4User.id, title: "Project Milestone", message: "Your \"Ramadan Food Drive 2026\" collected over 2,000 food parcels!", type: "SUCCESS", isRead: false, link: "/projects" },

      // Charity - Himaya (charity5)
      { userId: charity5User.id, title: "Registration Pending", message: "Your registration request is under review. You will be notified once it's approved.", type: "INFO", isRead: false, link: "/charities/profile" },
      { userId: charity5User.id, title: "Verification Pending", message: "Your verification documents are being reviewed by our team.", type: "INFO", isRead: false, link: "/charities/profile" },
      { userId: charity5User.id, title: "New Application Received", message: "Rami Najjar applied for \"Child Safety Workshop — School Training\".", type: "INFO", isRead: true, link: "/charities/applications" },

      // Volunteers
      { userId: vol1.id, title: "Application Approved!", message: "Your application for \"Karantina Market — April Weekend Volunteers\" has been approved. You've been added to the volunteer room.", type: "SUCCESS", isRead: false, link: "/user/rooms/38" },
